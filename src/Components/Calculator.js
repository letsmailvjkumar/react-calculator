...
const Calculator = ()=>{
    ...
    return (
        ...
        <div className='res'>
             ...
             {error === "Num1 cannot be empty" && <h4 className="error-message">Num 1 Cannot Be Empty</h4>}
             {error === "Num2 cannot be empty" && <h4 className="error-message">Num 2 Cannot Be Empty</h4>}
